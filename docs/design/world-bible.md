...
This document defines the canonical identity of the V3 worlds.

The Website V3 Master Parameters define how the project is built.  
The World Bible defines what each world is.
...
- Compass positions are fixed once approved.
- Locked worlds are protected design assets.
- Future implementation must preserve the world identity.
- Visuals, animations, layouts, and transitions should express the world identity.
...
Every performance strengthens the city.  
...
Every genre belongs.  
Every level of musician belongs.  
Every performance matters.  
Every connection deserves to be remembered.
...
The city grows as the Archive grows.  
More venues, shows, artists, contributors, and memories create more city.
...
The Four Pillars represent the foundation of the world:
...
Everything else in The Soundtrack grows outward from those pillars.
...
Light functions almost like nature here.
...
- Venue-scale districts: local bar, club, theater, arena, festival, stadium.
- City lights synchronized to music.
- Hidden rhythmic easter egg where the city pulses to the drumbeat of a specific song.
- Personal music journey references: 90s dance/pop, country, rock, metal.
- Music theory references woven into architecture or exploration.
