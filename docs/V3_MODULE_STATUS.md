...
| Music Nexus | active | Active music module surface. | none | Needs focused mobile QA for nested views and drilldowns. | Routed at `/music`; also owns current band/radar/list/search views. | Continue separating module behavior from shell routing while preparing for backend data adapters. |
