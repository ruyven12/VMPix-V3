...
// Detached presentation keeps cold Bands loads free of legacy mounted chrome.
function queryRetainedMusicElement(selector) {
  return document.querySelector(selector) || document.getElementById('music-presentation-template')?.content.querySelector(selector) || document.getElementById('shell-rail-template')?.content.querySelector(selector) || null;
}
function queryRetainedMusicElements(selector) {
...
const bottomRail = queryRetainedMusicElement("[data-shell-bottom-rail]");
const shellBackButton = queryRetainedMusicElement("[data-shell-back]");
const railMenuTrigger = queryRetainedMusicElement("[data-rail-menu-trigger]");
...
const currentView = queryRetainedMusicElement("[data-current-view]");
...
const musicNexusShell = queryRetainedMusicElement("[data-music-nexus-shell]");
const musicNexusLanding = queryRetainedMusicElement("[data-music-nexus-landing]");
const musicLandingRouteCards = queryRetainedMusicElements("[data-music-landing-route]");
const musicNexusCards = queryRetainedMusicElements("[data-music-nexus-card]");
...
const showDetail = queryRetainedMusicElement("[data-show-detail]");
const venueDetail = queryRetainedMusicElement("[data-venue-detail]");
const musicVenuesIndex = queryRetainedMusicElement("[data-music-venues-index]");
const musicVenuesFilters = queryRetainedMusicElement("[data-music-venues-filters]");
const musicVenuesList = queryRetainedMusicElement("[data-music-venues-list]");
const musicVenuesCount = queryRetainedMusicElement("[data-music-venues-count]");
const venueDetailBack = queryRetainedMusicElement("[data-venue-detail-back]");
const venueDetailLogoCard = queryRetainedMusicElement("[data-venue-detail-logo-card]");
const venueDetailLogoMark = queryRetainedMusicElement("[data-venue-detail-logo-mark]");
const venueDetailLogoLabel = queryRetainedMusicElement("[data-venue-detail-logo-label]");
const venueDetailTitle = queryRetainedMusicElement("[data-venue-detail-title]");
const venueDetailLocation = queryRetainedMusicElement("[data-venue-detail-location]");
const venueDetailRegion = queryRetainedMusicElement("[data-venue-detail-region]");
const venueDetailVisual = queryRetainedMusicElement("[data-venue-detail-visual]");
const venueDetailVisualPrimary = queryRetainedMusicElement("[data-venue-detail-visual-primary]");
const venueDetailVisualSecondary = queryRetainedMusicElement("[data-venue-detail-visual-secondary]");
const venueDetailStatValues = Array.from(queryRetainedMusicElements("[data-venue-detail-stat]"));
const musicNexusBack = queryRetainedMusicElement("[data-music-nexus-back]");
const bandsViewButtons = queryRetainedMusicElements("[data-bands-view-target]");
const bandsViewPanels = queryRetainedMusicElements("[data-bands-view]");
const bandsLetterNavs = queryRetainedMusicElements("[data-bands-letter-nav], [data-bands-letter-nav-list]");
const bandsStatus = queryRetainedMusicElement("[data-bands-status]");
const bandsRadarLetter = queryRetainedMusicElement("[data-bands-radar-letter]");
const bandsRadarCount = queryRetainedMusicElement("[data-bands-radar-count]");
const bandsRadarSignals = queryRetainedMusicElement("[data-bands-radar-signals]");
const bandsRadarPoints = queryRetainedMusicElement("[data-bands-radar-points]");
const bandsList = queryRetainedMusicElement("[data-bands-list]");
const bandsEmpty = queryRetainedMusicElement("[data-bands-empty]");
const bandsListFilterBar = queryRetainedMusicElement("[data-bands-list-filter-bar]");
const bandsFilterLetter = queryRetainedMusicElement("[data-bands-filter-letter]");
const bandsFilterSummary = queryRetainedMusicElement("[data-bands-filter-summary]");
const bandsBackRadar = queryRetainedMusicElement("[data-bands-back-radar]");
const bandsSearchInput = queryRetainedMusicElement("[data-bands-search-input]");
const bandsSearchResults = queryRetainedMusicElement("[data-bands-search-results]");
const bandsSearchSummary = queryRetainedMusicElement("[data-bands-search-summary]");
const bandsSearchChips = queryRetainedMusicElements("[data-bands-search-term]");
const bandsFilterSelects = queryRetainedMusicElements("[data-bands-filter]");
const bandsFilterResetButtons = queryRetainedMusicElements("[data-bands-filter-reset]");
const bandDetail = queryRetainedMusicElement("[data-band-detail-placeholder]");
const bandDetailBack = queryRetainedMusicElement("[data-band-detail-back]");
const bandDetailPoster = queryRetainedMusicElement(".band-detail-poster");
const bandDetailLogoImage = queryRetainedMusicElement("[data-band-detail-logo-image]");
const bandDetailThumb = queryRetainedMusicElement("[data-band-detail-thumb]");
const bandDetailLogoName = queryRetainedMusicElement("[data-band-detail-logo-name]");
const bandDetailName = queryRetainedMusicElement("[data-band-detail-name]");
const bandDetailRegion = queryRetainedMusicElement("[data-band-detail-region]");
const bandDetailTags = queryRetainedMusicElement("[data-band-detail-tags]");
const bandDetailStatus = queryRetainedMusicElement("[data-band-detail-status]");
const bandDetailLocation = queryRetainedMusicElement("[data-band-detail-location]");
const bandDetailCompletionValue = queryRetainedMusicElement("[data-band-detail-completion-value]");
const bandDetailProgressFill = queryRetainedMusicElement("[data-band-detail-progress-fill]");
const bandDetailYearsCovered = queryRetainedMusicElement("[data-band-detail-years-covered]");
const bandDetailMostActiveYear = queryRetainedMusicElement("[data-band-detail-most-active-year]");
const bandDetailTotalPhotos = queryRetainedMusicElement("[data-band-detail-total-photos]");
const bandDetailContributors = queryRetainedMusicElement("[data-band-detail-contributors]");
const bandDetailSetsCaptured = queryRetainedMusicElement("[data-band-detail-sets-captured]");
const bandDetailDataStatus = queryRetainedMusicElement("[data-band-detail-data-status]");
const bandDetailLatestSeen = queryRetainedMusicElement("[data-band-detail-latest-seen]");
const bandDetailLifecycleStatus = queryRetainedMusicElement("[data-band-detail-lifecycle-status]");
const bandDetailLastUpdated = queryRetainedMusicElement("[data-band-detail-last-updated]");
const bandDetailCoreMembers = queryRetainedMusicElement("[data-band-detail-core-members]");
const bandDetailPastMembers = queryRetainedMusicElement("[data-band-detail-past-members]");
const bandDetailViewSets = queryRetainedMusicElement("[data-band-detail-view-sets]");
const setsArchive = queryRetainedMusicElement("[data-sets-archive]");
const setsArchiveBack = queryRetainedMusicElement("[data-sets-archive-back]");
const setsArchiveBand = queryRetainedMusicElement("[data-sets-archive-band]");
const setsArchiveSummary = queryRetainedMusicElement("[data-sets-archive-summary]");
const setsList = queryRetainedMusicElement("[data-sets-list]");
const setsRows = queryRetainedMusicElements("[data-set-row]");
const setsFeaturedImage = queryRetainedMusicElement("[data-sets-featured-image]");
const setsFeaturedPoster = queryRetainedMusicElement("[data-sets-featured-poster]");
const setsFeaturedThumb = queryRetainedMusicElement("[data-sets-featured-thumb]");
const setsFeaturedDate = queryRetainedMusicElement("[data-sets-featured-date]");
const setsFeaturedTitle = queryRetainedMusicElement("[data-sets-featured-title]");
const setsFeaturedLocation = queryRetainedMusicElement("[data-sets-featured-location]");
const setsFeaturedPhotos = queryRetainedMusicElement("[data-sets-featured-photos]");
const setsFeaturedContributors = queryRetainedMusicElement("[data-sets-featured-contributors]");
const setsFeaturedComplete = queryRetainedMusicElement("[data-sets-featured-complete]");
const setsFeaturedOpen = queryRetainedMusicElement("[data-sets-open-set]");
const setDetailPlaceholder = queryRetainedMusicElement("[data-set-detail-placeholder]");
const setDetailClose = queryRetainedMusicElement("[data-set-detail-close]");
const setDetailBand = queryRetainedMusicElement("[data-set-detail-band]");
const setDetailTitle = queryRetainedMusicElement("[data-set-detail-title]");
const setDetailCopy = queryRetainedMusicElement("[data-set-detail-copy]");
const setDetailDate = queryRetainedMusicElement("[data-set-detail-date]");
const setDetailLocation = queryRetainedMusicElement("[data-set-detail-location]");
const setDetailPhotos = queryRetainedMusicElement("[data-set-detail-photos]");
const setDetailContributors = queryRetainedMusicElement("[data-set-detail-contributors]");
const setDetailComplete = queryRetainedMusicElement("[data-set-detail-complete]");
const setGallery = queryRetainedMusicElement("[data-set-gallery]");
const setGalleryBack = queryRetainedMusicElement("[data-set-gallery-back]");
const setGalleryBand = queryRetainedMusicElement("[data-set-gallery-band]");
const setGalleryImage = queryRetainedMusicElement("[data-set-gallery-image]");
const setGalleryPoster = queryRetainedMusicElement("[data-set-gallery-poster]");
const setGalleryThumb = queryRetainedMusicElement("[data-set-gallery-thumb]");
const setGalleryDate = queryRetainedMusicElement("[data-set-gallery-date]");
const setGalleryTitle = queryRetainedMusicElement("[data-set-gallery-title]");
const setGalleryShowId = queryRetainedMusicElement("[data-set-gallery-show-id]");
const setGalleryCity = queryRetainedMusicElement("[data-set-gallery-city]");
const setGalleryVenue = queryRetainedMusicElement("[data-set-gallery-venue]");
const setGalleryPerformance = queryRetainedMusicElement("[data-set-gallery-performance]");
const setGalleryPhotos = queryRetainedMusicElement("[data-set-gallery-photos]");
const setGalleryContributors = queryRetainedMusicElement("[data-set-gallery-contributors]");
const setGalleryQuality = queryRetainedMusicElement("[data-set-gallery-quality]");
const setGalleryCamera = queryRetainedMusicElement("[data-set-gallery-camera]");
const setGalleryNotes = queryRetainedMusicElement("[data-set-gallery-notes]");
const galleryGrid = queryRetainedMusicElement("[data-gallery-grid]");
const galleryPhotoTiles = queryRetainedMusicElements("[data-gallery-photo]");
const galleryViewOptions = queryRetainedMusicElements("[data-gallery-view-option]");
const galleryPhotoCount = queryRetainedMusicElement("[data-gallery-count]");
const galleryPhotoWarning = queryRetainedMusicElement("[data-gallery-warning]");
const galleryStatesShell = queryRetainedMusicElement("[data-gallery-states]");
const galleryStates = queryRetainedMusicElements("[data-gallery-state]");
const galleryViewAll = queryRetainedMusicElement("[data-gallery-view-all]");
const galleryLightboxPrep = queryRetainedMusicElement("[data-gallery-lightbox-prep]");
const galleryLightboxTitle = queryRetainedMusicElement("[data-gallery-lightbox-title]");
const lightboxScreen = queryRetainedMusicElement("[data-lightbox-screen]");
const lightboxBack = queryRetainedMusicElement("[data-lightbox-back]");
const lightboxPhoto = queryRetainedMusicElement("[data-lightbox-photo]");
const lightboxImage = queryRetainedMusicElement("[data-lightbox-image]");
const lightboxPhotoTitle = queryRetainedMusicElement("[data-lightbox-photo-title]");
const lightboxCounter = queryRetainedMusicElement("[data-lightbox-counter]");
const lightboxPrev = queryRetainedMusicElement("[data-lightbox-prev]");
const lightboxNext = queryRetainedMusicElement("[data-lightbox-next]");
const lightboxInfoToggle = queryRetainedMusicElement("[data-lightbox-info-toggle]");
const lightboxInfoPanel = queryRetainedMusicElement("[data-lightbox-info-panel]");
const lightboxDrawerClose = queryRetainedMusicElement("[data-lightbox-drawer-close]");
const lightboxMetaTitle = queryRetainedMusicElement("[data-lightbox-meta-title]");
const lightboxMetaBandTags = queryRetainedMusicElement("[data-lightbox-meta-band-tags]");
const lightboxMetaPeopleTags = queryRetainedMusicElement("[data-lightbox-meta-people-tags]");
const lightboxMetaShow = queryRetainedMusicElement("[data-lightbox-meta-show]");
const lightboxMetaVenue = queryRetainedMusicElement("[data-lightbox-meta-venue]");
const lightboxMetaLocation = queryRetainedMusicElement("[data-lightbox-meta-location]");
const lightboxMetaDate = queryRetainedMusicElement("[data-lightbox-meta-date]");
const lightboxMetaPerformance = queryRetainedMusicElement("[data-lightbox-meta-performance]");
const lightboxMetaCamera = queryRetainedMusicElement("[data-lightbox-meta-camera]");
const lightboxMetaSource = queryRetainedMusicElement("[data-lightbox-meta-source]");
const lightboxViewToggles = queryRetainedMusicElements("[data-lightbox-view-toggle]");
const lightboxThumbnailStrip = queryRetainedMusicElement("[data-lightbox-thumbnail-strip]");
const lightboxThumbButtons = queryRetainedMusicElements("[data-lightbox-thumb]");
const lightboxFullscreenToggle = queryRetainedMusicElement("[data-lightbox-fullscreen-toggle]");
...
const WRESTLING_MATCH_DETAIL_SHOW_ID = "062026";
const WRESTLING_MATCH_DETAIL_MATCH_ID = "match-1";

function isWrestlingMatchDetailRoute(route) {
  if (!route) {
    return false;
  }

  const routeName = String(route.name || "");
  if (routeName !== "wrestling-match-detail" && routeName !== "wrestling-match-detail-photo") {
    return false;
  }
  ...
  return Boolean(routeShowId && routeMatchId);
}

function isWrestlingMatchDetailPhotoRoute(route) {
  return Boolean(route?.name === "wrestling-match-detail-photo" && isWrestlingMatchDetailRoute(route) && route.photoId);
}
...
const routeNameToGlobalNavTarget = {
  ...
  "wrestling-match-detail": "wrestling",
  "wrestling-match-detail-photo": "wrestling",
...
const routeNameToBreadcrumbTrail = {
  ...
  "wrestling-match-detail": ["portfolio", "wrestling", "wrestling-shows"],
  "wrestling-match-detail-photo": ["portfolio", "wrestling", "wrestling-shows"],
...
let daiionCrusadesInterfaceReadyTimer = 0;
let daiionCrusadesCarouselReadyTimer = 0;
let daiionCrusadesCampaignInfoReadyTimer = 0;
...
function getDaiionCrusadesInterfaceShell() {
  return document.querySelector("[data-wrestling-shows-shell]");
}

function setDaiionCrusadesInterfaceControlsEnabled(isEnabled) {
  getDaiionCrusadesInterfaceShell()?.querySelectorAll(".hall-crusades-archive-crystal").forEach((control) => {
...
function syncDaiionCrusadesImpactPointFromEmitters() {
  const shell = document.querySelector(".site-shell");
  ...
  if (!shell || !leftEmitter || !rightEmitter) {
    return;
  }
  ...
  shell.style.setProperty("--daiion-crusades-impact-x", `${(leftCenterX + rightCenterX) / 2}px`);
  shell.style.setProperty("--daiion-crusades-impact-y", `${(leftCenterY + rightCenterY) / 2}px`);
}

function setDaiionCrusadesInterfacePreview(isVisible) {
  ...
  if (!isVisible) {
    if (showsShell.dataset.daiionCrusadesInterfacePreview === "true") {
      showsShell.setAttribute("aria-hidden", "true");
      showsShell.setAttribute("inert", "");
      showsShell.removeAttribute("data-wrestling-shows-variant");
    }
  ...
  showsShell.dataset.daiionCrusadesInterfacePreview = "true";
  showsShell.setAttribute("aria-hidden", "false");
  showsShell.removeAttribute("inert");
  setDaiionCrusadesInterfaceControlsEnabled(false);
...
function resetDaiionCrusadesConvergencePrototype() {
  ...
  window.clearTimeout(daiionCrusadesInterfaceReadyTimer);
  daiionCrusadesInterfaceReadyTimer = 0;
  window.clearTimeout(daiionCrusadesCarouselReadyTimer);
  daiionCrusadesCarouselReadyTimer = 0;
  window.clearTimeout(daiionCrusadesCampaignInfoReadyTimer);
  ...
  setDaiionCrusadesInterfacePreview(false);
...
function startDaiionCrusadesConvergencePrototype() {
  ...
  shell.style.setProperty("--daiion-crusades-impact-x", `${targetX}px`);
  shell.style.setProperty("--daiion-crusades-impact-y", `${targetY}px`);
  ...
  shell.classList.remove("is-daiion-crusades-campaign-info-revealing", "is-daiion-crusades-campaign-info-ready");
  ...
  if (typeof preloadDaiionCrusadesInterfaceData === "function") {
    preloadDaiionCrusadesInterfaceData();
  }
  ...
  daiionCrusadesWarpTimer = window.setTimeout(() => {
  ...
  daiionCrusadesRestoredTimer = window.setTimeout(() => {
    ...
    setDaiionCrusadesEngineBarDestinationTitle();
    setDaiionCrusadesInterfacePreview(true);
    shell.classList.remove("is-daiion-crusades-engine-reconstructing");
    shell.classList.add("is-daiion-crusades-engine-restored", "is-daiion-crusades-interface-initializing");
    window.clearTimeout(daiionCrusadesInterfaceReadyTimer);
    daiionCrusadesInterfaceReadyTimer = window.setTimeout(() => {
      if (!daiionCrusadesConvergenceInProgress) {
        daiionCrusadesInterfaceReadyTimer = 0;
        return;
      }
      shell.classList.add("is-daiion-crusades-interface-ready", "is-daiion-crusades-carousel-revealing");
      setDaiionCrusadesInterfaceControlsEnabled(true);
      if (typeof syncHallCrusadesPosterNavControls === "function") {
        syncHallCrusadesPosterNavControls();
      }
      window.clearTimeout(daiionCrusadesCarouselReadyTimer);
      daiionCrusadesCarouselReadyTimer = window.setTimeout(() => {
        if (!daiionCrusadesConvergenceInProgress) {
          daiionCrusadesCarouselReadyTimer = 0;
          return;
        }
        shell.classList.remove("is-daiion-crusades-carousel-revealing");
        shell.classList.add("is-daiion-crusades-carousel-ready", "is-daiion-crusades-campaign-info-revealing");
        if (typeof syncHallCrusadesPosterNavControls === "function") {
          syncHallCrusadesPosterNavControls();
        }
        window.clearTimeout(daiionCrusadesCampaignInfoReadyTimer);
        daiionCrusadesCampaignInfoReadyTimer = window.setTimeout(() => {
          if (!daiionCrusadesConvergenceInProgress) {
            daiionCrusadesCampaignInfoReadyTimer = 0;
            return;
          }
